export let projects = [
  {
    ...
    description:
      "A restaurant reservations platform designed to manage booking, seating, and managing reservations.",
    github_url: "https://github.com/meleciosilva/reservations",
    live_url:
      "https://restaurant-reservation-frontend-gilt.vercel.app/dashboard?date=2020-12-30",
  ...
  },
  {
    ...
    description:
      "An online learning tool designed to help students study course content with flashcards.",
  ...
  },
  {
    ...
    name: "We Love Movies",
    description:
      "A movie theater platform designed to help users navigate movies and showing theaters.",
  ...
  },
  {
    ...
    name: "Event Manager",
    description:
      "An Express RESTful API built with a series of routes to manage users and access or manipulate data for events.",
  ...
  },
  {
    ...
    name: "VA Breweries",
    description:
      "A directory of breweries, brewhubs, cideries, and craft beer bottle shops located in Virginia.",
    ...
    technology: [
      ...
      "<p>Developed pagination, search filtering, and sorting with <strong>JavaScript</strong></p>",
  ...
  },
  {
    ...
    name: "Decoder Ring",
    description:
      "A set of ciphers used to encode and decode messages (Caesar's Shift, Polybius Square, and Substitution).",
